	...
	return (
		<>
			<div
				...
				style={{ backgroundImage: `url("/bg_search/image_bg_cover_search.jpg")`, backgroundSize: 'cover', backgroundPosition: 'center', height: '350px', backgroundColor: 'rgba(33, 158, 188, 0.5' }}>
