...
const About = () => {
	return (
		<div className='max-w-screen-2xl h-[calc(100vh-11.7rem)] bg-black m-auto relative flex flex-col justify-center items-center'>
			<div className='flex flex-col justify-center items-center z-10'>
				<h2 className='-mb-10 md:-mb-16 text-7xl md:text-9xl font-serif'>Hi there!</h2>
				<Image src={deadpool} alt='deadpool' width={600} height={400} />
				<p className='px-5 md:px-32 md:text-xl mt-5 text-justify'>
